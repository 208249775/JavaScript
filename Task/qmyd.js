...
############## loon
#全民悦动获取TOKEN
http-response https:\/\/qmyd\.yichengw\.cn\/* script-path=https://cdn.jsdelivr.net/gh/ziye888/JavaScript@main/Task/qmyd.js, requires-body=1,max-size=0, tag=全民悦动获取TOKEN

############## surge
#全民悦动获取TOKEN
全民悦动获取TOKEN = type=http-response,pattern=https:\/\/qmyd\.yichengw\.cn\/*,script-path=https://cdn.jsdelivr.net/gh/ziye888/JavaScript@main/Task/qmyd.js
